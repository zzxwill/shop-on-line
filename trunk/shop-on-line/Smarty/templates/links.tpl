...
<table width="207" height="211" border="0" cellpadding="0" cellspacing="0" background="images/shop_13.gif" id="__01">
  ...
  <tr>
    ...
    <td width="183" rowspan="2" align="left" valign="top" style="line-height: 25px;">{foreach key=key item=item from=$arr}
    <a href="{$item.url}" target="_blank" class="lk">{$item.name}</a><br />
    {/foreach}    </td>
  </tr>
</table>
