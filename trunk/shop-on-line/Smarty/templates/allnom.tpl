    ...
    <table width="636" height="134" border="0" cellspacing="0" cellpadding="0">
    	...
    	<tr>
    	  <td height="30">会员价格：<font color="#FF0000">{$item.v_price}&nbsp;元</font></td>
  	      <td height="30" colspan="2" align="center" valign="middle"><input id="allshow" name="allshow" type="image" src="images/look.JPG" value="" class="showinfo" onclick="openshowcommo({$item.id})"  />  &nbsp;<input id="buy" name="buy" type="image" src="images/looks.JPG" value="" class="buy" onclick="return buycommo({$item.id})" /></td>
    	</tr>
    </table>
