...
{foreach key=key item=item from=$arr}
    <tr>
      ...
      <td width="100" align="center" valign="middle" class="right"><input id="modify" name="modify" type="button" class="btn" value="修改" onclick="javascript:showdiv('{$key}','{$item[0]}');" style="border-color:#FFFFFF;"/><input id="delete" name="delete" type="button" value="删除" class="btn" onclick="javascript:deladmin({$key});" style="border-color:#FFFFFF;"></td>
    </tr>
{/foreach}
</form>
</table>
