...
{foreach key=key item=item from=$searcharr} 
  ...
  <tr>
    <td height="25" align="center" valign="middle" class="center">图书语言：</td>
  ...
  <tr>
    <td height="25" align="center" valign="middle" class="center">出版社：</td>
  ...
  <tr>
    ...
    <td align="center" valign="middle" class="right"><input id="buy" name="buy" type="image" src="images/looks.JPG" value="" class="buy" onclick="return subbuycommo({$item.id})" ></td>
  </tr>
{/foreach}
</table>
